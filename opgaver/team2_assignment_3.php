<?php
	...
	<li>Help Santa! Santa needs help getting two more presents - Your team needs to buy these - see the prescriptions below:
		<ul>
			<li>each present must cost no more than 125 kr</li>
			<li>each present cannot be drink or food</li>
			<li>each present must be at least partly red</li>
